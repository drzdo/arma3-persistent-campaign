/**
Serialize inventory of a container.
Tracks nested containers as well, but flattens the list of item.
 */
...
private _items = [];
{
    ...
    private _nestedI = 0;
    {
        ...
        if (_nestedType == _type) then {
            ...
            private _rChild = [_nestedObj] call zdo_util_fnc_serializeContainer;
